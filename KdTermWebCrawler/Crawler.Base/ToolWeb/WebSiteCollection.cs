...
namespace Crawler
{
    ...
    {
        public WebSiteCollection(WebSiteCrawller crawller)
        {
            this.WebCrawller = crawller;
        }
        ...
        {
            if (this.WebCrawller != null && this.WebCrawller.MaxEndTime > 0)
            {
                System.Threading.Thread.Sleep(WebCrawller.MaxEndTime * 1000);
            }
        }
        private WebSiteCrawller _WebCrawller;
        /// <summary>
        /// 当前抓取配置
        /// </summary>
        public WebSiteCrawller WebCrawller
        {
            set { _WebCrawller = value; }
            get { return _WebCrawller; }
        }
        ...
        /// <returns></returns>
        public string GetHtmlByUrl(string url, Encoding encode = null)
        {
            this.LoadWebSite();
            url = url.Replace("\r\n", "").Replace("\r", "").Replace("\n", "").Replace("\t", "");
        ...
        /// <returns></returns>
        public string GetHtmlByUrl(string url, Encoding encode, ref string cookiestr)
        {
            this.LoadWebSite();
            url = url.Replace("\r\n", "").Replace("\r", "").Replace("\n", "").Replace("\t", "");
            string html = string.Empty;
        ...
        /// <returns></returns>
        public string GetHtmlByUrl(string url, NameValueCollection postValues)
        {
        ...
        /// <param name="encode"></param>
        /// <returns></returns>
        public string GetHtmlByUrl(string url, NameValueCollection postValues, Encoding encode)
        {
        ...
        /// <returns></returns>
        public string GetHtmlByUrl(string url, NameValueCollection postValues, Encoding encode, bool onlyGetAjaxCtx)
        {
            string cookies = string.Empty;
            return GetHtmlByUrl(url, postValues, encode, onlyGetAjaxCtx, ref cookies);
        }
        ...
        /// <param name="encode"></param>
        /// <returns></returns>
        public string GetHtmlByUrl(string url, NameValueCollection postValues, Encoding encode, ref string cookiestr)
        {
            return GetHtmlByUrl(url, postValues, encode, false, ref cookiestr);
        }
        ...
        /// <returns></returns>
        public string GetHtmlByUrl(string url, NameValueCollection postValues, Encoding encode, bool onlyGetAjaxCtx, ref string cookies)
        {
            this.LoadWebSite();
            string html = string.Empty;
            url = url.Replace("\r\n", "").Replace("\r", "").Replace("\n", "").Replace("\t", "");
            WebClient myWebClient = GetDefaultWebClient(onlyGetAjaxCtx);
        ...
        /// <param name="cookies"></param>
        /// <returns></returns>
        public string GetHtmlByUrlAndIsError(string url, NameValueCollection postValues, Encoding encode, ref bool isError)
        {
            this.LoadWebSite();
            string html = string.Empty;
            url = url.Replace("\r\n", "").Replace("\r", "").Replace("\n", "").Replace("\t", "");
        ...
        /// <returns></returns>
        public WebClient GetDefaultWebClient(bool onlyGetAjaxCtx)
        {
        ...
        /// <returns></returns>
        public NameValueCollection GetNameValueCollection(string[] names, string[] values)
        {
        ...
        /// <returns></returns>
        public string UrlEncode(string url, Encoding enc)
        {
        ...
        /// <returns></returns>
        public string GetAspNetViewState(string html)
        {
        ...
        /// <returns></returns>
        public string GetAspNetViewState(Parser parser)
        {
        ...
        /// <param name="html"></param>
        /// <returns></returns>
        public string GetAspNetEventValidation(string html)
        {
            Parser parser = new Parser(new Lexer(html));
        ...
        /// <param name="parser"></param>
        /// <returns></returns>
        public string GetAspNetEventValidation(Parser parser)
        {
        ...
        /// <returns></returns>
        public NameValueCollection GetAspNetNameValueCollection(string viewState, string eventTarget, string eventArgument)
        {
