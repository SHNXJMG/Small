...
{
    public class NotifyInfoZSQTLC : WebSiteCrawller
    {
        public NotifyInfoZSQTLC()
            : base()
        {
            this.Group = "办事指南";
            this.Title = "广东省中山市区工程交易信息网（其它流程 ）服务指南";
            this.Description = "自动抓取广东省中山市区工程交易信息网（其它流程 ）服务指南";
            this.PlanTime = "21:24";
            this.SiteUrl = "http://www.zsjyzx.gov.cn/zsweb/index/showList/000000000008/000000000426";
            this.MaxCount = 500;
