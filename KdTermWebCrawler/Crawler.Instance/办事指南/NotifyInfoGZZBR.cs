...
{
    public class NotifyInfoGZZBR : WebSiteCrawller
    {
        public NotifyInfoGZZBR()
            : base()
        {
            this.Group = "办事指南";
            this.Title = "广东省广州市建设工程交易中心（招标人）办事指南";
            this.Description = "自动抓取广东省广州市建设工程交易中心（招标人）办事指南";
            this.PlanTime = "22:06";
            this.SiteUrl = "http://www.gzzb.gd.cn/cms/wz/view/fwzn/bszy_list.jsp?siteId=1&channelId=44";
            this.MaxCount = 500;
