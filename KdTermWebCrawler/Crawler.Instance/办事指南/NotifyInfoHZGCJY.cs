...
{
    public class NotifyInfoHZGCJY : WebSiteCrawller
    {
        public NotifyInfoHZGCJY()
            : base()
        {
            this.Group = "办事指南";
            this.Title = "广东省惠州市建设工程交易中心（工程交易流程）服务指南";
            this.PlanTime = "21:28";
            this.Description = "自动抓取广东省惠州市建设工程交易中心（工程交易流程）服务指南";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000008/000000000401";
            this.MaxCount = 500;
        }
