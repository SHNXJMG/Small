...
{
    public class NotifyInfoGZJFZY : WebSiteCrawller
    {
        public NotifyInfoGZJFZY()
            : base()
        {
            this.Group = "办事指南";
            this.Title = "广东省广州市建设工程交易中心（缴费指引）办事指南";
            this.Description = "自动抓取广东省广州市建设工程交易中心（缴费指引）办事指南";
            this.PlanTime = "22:14";
            this.SiteUrl = "http://www.gzzb.gd.cn/cms/wz/view/fwzn/bszy_list.jsp?siteId=1&channelId=89";
            this.MaxCount = 500;
