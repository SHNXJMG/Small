...
{
    public class NotifyInfoDGTBRFW : WebSiteCrawller
    {
        public NotifyInfoDGTBRFW()
            : base()
        {
            this.Group = "办事指南";
            this.Title = "广东省东莞市建设工程交易中心（投标人服务）办事指南";
            this.Description = "自动抓取广东省东莞市建设工程交易中心（投标人服务）办事指南";
            this.PlanTime = "21:06";
            this.SiteUrl = "http://www.dgzb.com.cn/DGJYWEB/SiteManage/Bszl_List.aspx?modeId=3";
            this.MaxCount = 500;
