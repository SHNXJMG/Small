...
{
    public class NotifyInfoDGZBRFW : WebSiteCrawller
    {
        public NotifyInfoDGZBRFW()
            : base()
        {
            this.Group = "办事指南";
            this.Title = "广东省东莞市建设工程交易中心（招标人服务）办事指南";
            this.Description = "自动抓取广东省东莞市建设工程交易中心（招标人服务）办事指南";
            this.PlanTime = "21:08";
            this.SiteUrl = "http://www.dgzb.com.cn/DGJYWEB/SiteManage/Bszl_List.aspx?modeId=2";
            this.MaxCount = 500;
