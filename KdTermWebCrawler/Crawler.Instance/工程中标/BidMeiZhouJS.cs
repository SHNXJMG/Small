...
{
    public class BidMeiZhouJS : WebSiteCrawller
    {
        public BidMeiZhouJS()
            : base() 
        {
            this.Group = "中标信息";
            this.Title = "广东省梅州市建设工程中标信息";
            this.Description = "自动抓取广东省梅州市建设工程中标信息";
            this.PlanTime = "9:30,11:30,14:30,16:30,18:30";
            this.SiteUrl = "http://market.meizhou.gov.cn/deptWebsiteAction.do?action=secondIndex&deptId=1925&issueTypeCode=009009002&issueTypeName=各县(市)中标公示&showSubNodeflag=1";
        }
