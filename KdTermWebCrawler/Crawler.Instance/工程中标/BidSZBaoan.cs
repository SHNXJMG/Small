...
{
    public class BidSZBaoan : WebSiteCrawller
    {
        public BidSZBaoan()
            : base()
        {
            ...
            this.Description = "自动抓取广东省深圳市宝安区中标信息";
            this.SiteUrl = "https://www.szjsjy.com.cn:8001/jyw-ba/jyxx/queryZBJieGuoList.do?page=1&rows=";
            this.MaxCount = 200;
        }
