...
{
    public class BidBeiJingKcsj : WebSiteCrawller
    {
        public BidBeiJingKcsj()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "北京市建设工程发包承包交易中心中标信息(勘察设计)";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取北京市建设工程发包承包交易中心中标信息(勘察设计)";
            this.SiteUrl = "http://www.bcactc.com/home/gcxx/now_kcsjzbgs.aspx";
            this.MaxCount = 400;
        }
