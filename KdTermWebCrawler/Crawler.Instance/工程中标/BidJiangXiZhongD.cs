...
{
    public class BidJiangXiZhongD : WebSiteCrawller
    {
        public BidJiangXiZhongD()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "江西省公共资源交易网中标信息(重点工程)";
            this.Description = "自动抓取江西省公共资源交易网中标信息(重点工程)";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.SiteUrl = "http://www.jxsggzy.cn/web/jyxx/002005/002005004/jyxx.html";
        }
