...
{
    public class BidJiangXiJiaoTong : WebSiteCrawller
    {
        public BidJiangXiJiaoTong()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "江西省公共资源交易网中标信息(交通工程)";
            this.Description = "自动抓取江西省公共资源交易网中标信息(交通工程)";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.SiteUrl = "http://www.jxsggzy.cn/web/jyxx/002002/002002005/jyxx.html";
        }
