...
{
    public class BidGuangXiGgzyJtgc : WebSiteCrawller
    {
        public BidGuangXiGgzyJtgc()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "广西省公共资源交易中心中标信息(交通工程)";
            this.Description = "自动抓取广西省公共资源交易中心中标信息(交通工程)";
            this.PlanTime = "9:05,11:15,14:15,16:15,18:15";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.SiteUrl = "http://www.gxzbtb.cn/gxzbw/showinfo/jyxx.aspx?QuYu=450001&categoryNum=001012004";
        }
        ...
        protected Dictionary<string, string> GetCitys()
        {
            ...
            if (listNode != null && listNode.Count > 0)
            {
                for (int i = 0; i < listNode.Count; i++)
                {
                    ...
                    string url = string.Format("http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu={0}&categoryNum=001012004", id);
                    dic.Add(city, url);
                }
            }
            return dic;
