...
{
    public class BidSiChuangZfcg : WebSiteCrawller
    {
        public BidSiChuangZfcg()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "四川省公共资源交易中心政府采购中标信息";
            this.Description = "自动抓取四川省公共资源交易中心政府采购中标信息";
            this.PlanTime = "8:52,9:42,10:32,11:32,13:42,15:02,16:32";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.spprec.com/sczw/jyfwpt/005002/005002004/005002004002/MoreInfo.aspx?CategoryNum=005002004002";
            this.MaxCount = 400;
        }
