...
namespace Crawler.Instance
{
    ...
    /// 广东省惠州市博罗县
    /// </summary>
    public class BidHuiZhouBLX : WebSiteCrawller
    {
        public BidHuiZhouBLX()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "广东省惠州市博罗县";
            this.PlanTime = "01:08,9:08,10:08,11:38,14:08,15:08,17:38";
            this.Description = "自动抓取广东省惠州市博罗县中标信息";
            this.ExistCompareFields = "Prov,City,Area,Road,Code,ProjectName,InfoUrl";
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000004/000000000394";
        }
            ...
            if (aNodes != null && aNodes.Count > 0)
            {
                ...
                for (int t = 1; t < table.RowCount - 1; t++)
                {
                    string code = string.Empty, buildUnit = string.Empty, prjName = string.Empty, prjAddress = string.Empty, inviteCtx = string.Empty,
                         bidType = string.Empty, specType = string.Empty, beginDate = string.Empty, endDate = string.Empty, remark = string.Empty, inviteCon = string.Empty, InfoUrl = string.Empty, ctx = string.Empty, CreateTime = string.Empty, FbTime = string.Empty, bidUnit = string.Empty, bidMoney = string.Empty, HtmlTxt = string.Empty;
                    ...
                    BidInfo info = ToolDb.GenBidInfo("广东省", "惠州市区", "博罗县", string.Empty, code, prjName, bidUnit, beginDate, buildUnit, beginDate, endDate, ctx, string.Empty, "惠州市建设工程交易中心", string.Empty, "建设工程", string.Empty, bidMoney, InfoUrl, string.Empty, HtmlTxt);
