...
namespace Crawler.Instance
{
    ...
    /// 广东省惠州市龙门县
    /// </summary>
    public class BidHuiZhouLMX : WebSiteCrawller
    {
        public BidHuiZhouLMX()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "广东省惠州市龙门县";
            this.PlanTime = "01:08,9:08,10:08,11:38,14:08,15:08,17:38";
            this.Description = "自动抓取广东省惠州市龙门县中标信息";
            this.ExistCompareFields = "Prov,City,Area,Road,Code,ProjectName,InfoUrl";
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000004/000000000396";
        }
        ...
        public void DealHtml(IList list, string html, bool crawlAll)
        {
            ...
            if (aNodes != null && aNodes.Count > 0)
            {
                ...
                for (int t = 1; t < table.RowCount - 1; t++)
                {
                    ...
                    BidInfo info = ToolDb.GenBidInfo("广东省", "惠州市区", "龙门县", string.Empty, code, prjName, bidUnit, beginDate, buildUnit, beginDate, endDate, ctx, string.Empty, "惠州市建设工程交易中心",bidType, "建设工程", string.Empty, bidMoney, InfoUrl, string.Empty, HtmlTxt);
