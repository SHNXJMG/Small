...
namespace Crawler.Instance
{
    ...
    /// 广东省惠州市惠阳区
    /// </summary>
    public class BidHuiZhouHYQ : WebSiteCrawller
    {
        public BidHuiZhouHYQ()
            : base()
        {
            this.Group = "中标信息";
            this.Title = "广东省惠州市惠阳区";
            this.Description = "自动抓取广东省惠州市惠阳区中标信息";
            ...
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000004/000000000393";
        }
