...
{
    public class BidMmzfcg : WebSiteCrawller
    {
        public BidMmzfcg()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "茂名市政府采购中标信息";
            this.PlanTime = "9:08,11:08,13:08,15:08,17:08";
            this.Description = "自动抓取茂名市政府采购中标信息";
            this.SiteUrl = "http://maoming.gdgpo.com/queryMoreInfoList/channelCode/0008.html";
            this.MaxCount = 50;
        }
