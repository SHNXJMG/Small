...
{
    public class BidInfoTianJinZfcgQx : WebSiteCrawller
    {
        public BidInfoTianJinZfcgQx()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "天津市政府采购网中标公告（区县）";
            this.Description = "自动抓取天津市政府采购网中标公告（区县）";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 1000;
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.SiteUrl = "http://www.tjgp.gov.cn/portal/topicView.do?method=view&view=Infor&id=2013&ver=2&stmp=1484300391618";
        }
