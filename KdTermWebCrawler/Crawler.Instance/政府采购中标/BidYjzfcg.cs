...
{
    public class BidYjzfcg : WebSiteCrawller
    {
        public BidYjzfcg()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "阳江市政府采购中标信息";
            this.PlanTime = "9:10,11:10,13:10,15:10,17:10";
            this.Description = "自动抓取阳江市政府采购中标信息";
            this.SiteUrl = "http://yangjiang.gdgpo.com/queryMoreInfoList/channelCode/0008.html";
            this.MaxCount = 50;
        }
