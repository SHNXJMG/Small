...
{
    public class BidMzzfcg : WebSiteCrawller
    {
        public BidMzzfcg()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "梅州市政府采购中标信息";
            this.PlanTime = "9:31,11:31,13:31,15:31,17:31";
            this.Description = "自动抓取梅州市政府采购中标信息";
            this.SiteUrl = "http://meizhou.gdgpo.com/queryMoreInfoList/channelCode/0008.html";
            this.MaxCount = 50;
        }
