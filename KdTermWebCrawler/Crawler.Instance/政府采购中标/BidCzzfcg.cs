...
{
    public class BidCzzfcg : WebSiteCrawller
    {
        public BidCzzfcg()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "潮州市政府采购中标信息";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取潮州市政府采购中标信息";
            this.SiteUrl = "http://chaozhou.gdgpo.com/queryMoreInfoList/channelCode/0008.html";
            this.MaxCount = 50;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    for (int j = 0; j < listNode.Count; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            BidInfo info = ToolDb.GenBidInfo("广东省", "潮州市区", "", string.Empty, code, prjName, buildUnit, beginDate, bidUnit, beginDate, endDate, bidCtx, string.Empty, msgType, bidType, specType, otherType, bidMoney, InfoUrl, prjMgr, HtmlTxt);
