...
{
    public class BidJmzfcg : WebSiteCrawller
    {
        public BidJmzfcg()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "江门市政府采购中标信息";
            this.PlanTime = "9:11,11:11,13:11,15:11,17:11";
            this.Description = "自动抓取江门市政府采购中标信息";
            this.SiteUrl = "http://jiangmen.gdgpo.com/queryMoreInfoList/channelCode/0008.html";
            this.MaxCount = 50;
        }
