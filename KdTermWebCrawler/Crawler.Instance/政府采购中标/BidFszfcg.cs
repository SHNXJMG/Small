...
{
    public class BidFszfcg : WebSiteCrawller
    {
        public BidFszfcg()
            : base()
        {
            this.Group = "政府采购中标信息";
            this.Title = "佛山市政府采购中标信息";
            this.PlanTime = "9:15,11:15,13:45,15:45,17:45";
            this.Description = "自动抓取佛山市政府采购中标信息";
            this.SiteUrl = "http://foshan.gdgpo.gov.cn/queryMoreInfoList/channelCode/0008.html";
            this.MaxCount = 50;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    for (int j = 0; j < listNode.Count; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            BidInfo info = ToolDb.GenBidInfo("广东省", "佛山市区", "", string.Empty, code, prjName, buildUnit, beginDate, bidUnit, beginDate, endDate, bidCtx, string.Empty, msgType, bidType, specType, otherType, bidMoney, InfoUrl, prjMgr, HtmlTxt);
