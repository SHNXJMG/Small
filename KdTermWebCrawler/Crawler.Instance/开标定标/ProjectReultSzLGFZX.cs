...
{
    public class ProjectReultSzLGFZX : WebSiteCrawller
    {
        public ProjectReultSzLGFZX()
            : base()
        {
            this.Group = "开标定标";
            this.Title = "深圳市建设交易服中心龙岗分中心定标结果公示";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取深圳市建设交易服中心龙岗分中心定标结果公示";
            this.SiteUrl = "https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/queryDBJieGuoList.do?page=1&rows=";
            this.MaxCount = 200;
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
        {
            ...
            foreach (KeyValuePair<string, object> obj in smsTypeJson)
            {
                ...
                foreach (object arrValue in array)
                {
                    ...
                    InfoUrl = "https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/queryOldOTDataDetail.do?type=9&id=" + Code;
                    ...
                    try
                    {
                        ...
                        {
                            InfoUrl = " https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/dbResult_View.do?bdGuid=" + bdId + "&ggGuid=" + ggId + "&dbJieGuoGuid=" + dbjieGuoid;
                            Html = this.ToolWebSite.GetHtmlByUrl(InfoUrl);
                            string url = "https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/queryDbJieGuoByGuid.do?guid=" + dbjieGuoid;
                    ...
                    if (!string.IsNullOrWhiteSpace(attachJson))
                    {
                        ...
                        try
                        {
                            ...
                            unitUrl = "https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/queryTbrListByBdGuidAndGgGuidForGs.do?bdGuid=" + bdGuid + "&ggGuid=" + ggGuid;
                        }
                        catch { }
                        ...
                        createTime = Convert.ToString(kdInfo["createTime2"]);
                        lxr = Convert.ToString(gc["lianXiRenName"]);
                        lxdh = Convert.ToString(gc["lianXiRenPhone"]);
                        try
                        {
                        ...
                        string surl = " https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/dbResult_View.do?bdGuid=" + bdId + "&ggGuid=" + ggId + "&dbJieGuoGuid=" + dbjieGuoid;
                        ...
                        if (tableNode != null && tableNode.Count > 0)
                        {
                            ...
                            Html = Html.GetReplace("<td id=\"lianXiRenName\">&nbsp;</td>", "<td id=\"lianXiRenName\">&nbsp;" + lxr + "</td>");
                            Html = Html.GetReplace("<td id=\"lianXiRenPhone\">&nbsp;</td>", "<td id=\"lianXiRenPhone\">&nbsp;" + lxdh + "</td>");
                            Ctx = Html.Replace("</tr>", "\r\n").ToCtxString();
                        }
                    ...
                    ProjectResult info = ToolDb.GetProjectResult("广东省", "深圳龙岗区工程", "龙岗区", Code, prjName, BuildUnit, FinalistsWay, RevStaMethod, SetStaMethod,
                    ...
                    if (ToolDb.SaveEntity(info, this.ExistCompareFields, this.ExistsUpdate, this.ExistsHtlCtx))
                    {
                        ...
                        {
                            string url = "https://www.szjsjy.com.cn:8001/jyw-lg/jyxx/filegroup/queryByGroupGuidZS.do?groupGuid=" + attachId;
