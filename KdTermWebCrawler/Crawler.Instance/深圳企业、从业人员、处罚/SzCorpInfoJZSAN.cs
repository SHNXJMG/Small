...
{
    public class SzCorpInfoJZSAN : WebSiteCrawller
    {
        public SzCorpInfoJZSAN()
            : base()
        {
            this.PlanTime = "3 23:30,10 23:30,18 23:30,26 23:30";//"1-28 2:00,4-28 2:00,7-28 2:00,10-28 2:00";
            this.Group = "企业信息";
            this.Title = "深圳市建设局企业信息（建筑业企业第三部分）";
            this.Description = "自动抓取深圳市建设局企业信息（建筑业企业第三部分）";
