...
{
    public class SzCorpInfoJZER : WebSiteCrawller
    {
        public SzCorpInfoJZER()
            : base()
        {
            this.PlanTime = "2 23:30,9 23:30,17 23:30,25 23:30";//"1-28 2:00,4-28 2:00,7-28 2:00,10-28 2:00";
            this.Group = "企业信息";
            this.Title = "深圳市建设局企业信息（建筑业企业第二部分）";
            this.Description = "自动抓取深圳市建设局企业信息（建筑业企业第二部分）";
