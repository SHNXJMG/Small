...
{
    public class BidSzGuoJiHe : WebSiteCrawller
    {
        public BidSzGuoJiHe()
            : base()
        {
            this.Group = "代理机构中标信息";
            this.Title = "广东省中广核工程有限公司国际中标信息";
            this.PlanTime = "9:15,11:15,13:45,15:45,17:45";
            this.Description = "自动抓取广东省中广核工程有限公司国际中标信息";
            this.SiteUrl = "http://bidding.cnpec.com.cn/member/tenderinformation.action?&filter_EQ_isinternational=1&filter_EQ_type=2";
        }
