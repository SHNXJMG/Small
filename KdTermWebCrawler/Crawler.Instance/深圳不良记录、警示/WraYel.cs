...
{
    public class WraYel : WebSiteCrawller
    {
        public WraYel()
            : base()
        {
            this.Group = "警示信息";
            this.Title = "深圳市住房和建设局半年度黄色警示信息";
            this.PlanTime = "1 3:00";
            this.Description = "自动抓取深圳市住房和建设局半年度黄色警示信息";
            this.ExistCompareFields = "WarningName,WarningType,PublicEndDate,CorpType";
            this.MaxCount = 200;
            this.SiteUrl = "http://61.144.226.2:8001/web/cxda/hldjsAction.do?method=toList&lamp=1";
        }
