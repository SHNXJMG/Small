...
namespace Crawler.Instance
{
    public class ToolLoginWeb
    {
        ...
        public static CookieContainer GetCooKie(string loginUrl, string postdata, HttpHeader header)
        {
            ...
            HttpWebRequest httpRequset = (HttpWebRequest)HttpWebRequest.Create(loginUrl);//创建http 请求
            httpRequset.CookieContainer = cookie;//设置cookie
            httpRequset.Method = "POST";//POST 提交
            httpRequset.KeepAlive = true;
            httpRequset.UserAgent = "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:45.0) Gecko/20100101 Firefox/45.0";
            httpRequset.Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
            ...
            StreamReader sr2 = new StreamReader(httpResponse.GetResponseStream(), Encoding.UTF8);
        ...
        public static string GetHtml(string getUrl, CookieContainer cookieContainer, HttpHeader header)
        {
            ...
            httpRequest.UserAgent = "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:45.0) Gecko/20100101 Firefox/45.0";
