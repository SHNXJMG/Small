...
{
    public class InviteSzCmcHWZB : WebSiteCrawller
    {
        public InviteSzCmcHWZB()
            : base()
        {
            this.Group = "代理机构招标信息";
            this.PlanTime = "9:15,11:15,13:45,15:45,17:45";
            this.Title = "中国机械进出口（集团）有限公司（货物招标）";
            this.Description = "自动抓取中国机械进出口（集团）有限公司招标信息（货物招标）";
            this.SiteUrl = "http://zb.cmc.com.cn/TenderNotice/List.aspx?id=2";
            this.MaxCount = 50;
        }
