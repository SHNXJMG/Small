...
{
    public class SzProjectZJS : WebSiteCrawller
    {
        public SzProjectZJS()
            : base(true)
        {
            ...
            this.Title = "深圳市住房与建设局工程基本信息（新版）";
            this.Description = "自动抓取深圳市住房与建设局工程基本信息（新版）";
            this.ExistCompareFields = "PrjCode";
            this.SiteUrl = "http://www.szjs.gov.cn/build/build.ashx?_=1352591600304&menu=%E9%A1%B9%E7%9B%AE%E4%BF%A1%E6%81%AF&type=%E6%96%BD%E5%B7%A5%E5%B7%A5%E7%A8%8B%E4%BF%A1%E6%81%AF&pageSize=20&pageIndex=1";
            this.MaxCount = 100;
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
        {
            ...
            for (int i = 1; i <= page; i++)
            {
                if (i > 1)
                {
                    try
                    {
                        htl = this.ToolWebSite.GetHtmlByUrl("http://www.szjs.gov.cn/build/build.ashx?_=1352591600304&menu=%E9%A1%B9%E7%9B%AE%E4%BF%A1%E6%81%AF&type=%E6%96%BD%E5%B7%A5%E5%B7%A5%E7%A8%8B%E4%BF%A1%E6%81%AF&pageSize=20&pageIndex=" + i.ToString(), Encoding.UTF8);
                    }
                    catch
                    {
                        continue;
