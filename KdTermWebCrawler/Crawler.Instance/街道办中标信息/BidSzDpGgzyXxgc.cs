...
{
    public class BidSzDpGgzyXxgc : WebSiteCrawller
    {
        public BidSzDpGgzyXxgc()
            : base()
        {
            this.Group = "街道办中标信息";
            this.Title = "深圳市大鹏新区公共资源交易中心小型建设工程中标公告";
            this.Description = "自动抓取深圳市大鹏新区公共资源交易中心小型建设工程中标公告";
            this.PlanTime = "9:30,11:30,14:30,16:30,18:30";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://113.105.69.184:51201/info_data/PT003-PT00303?pageIndex=1&pageSize=";
            this.MaxCount = 150;
        }
