...
namespace Crawler.Instance
{
    ...
    /// 广州市番禺区
    /// </summary>
    public class InviteGzPanyuSmall : WebSiteCrawller
    {
        public InviteGzPanyuSmall()
            : base()
        {
            this.Group = "招标信息";
            ...
            this.SiteUrl = "http://js.panyu.gov.cn/cd_xegcxm.aspx";
        }
            ...
            {             
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 0; j < table.RowCount - 1; j++)
                    {
                        ...
                        NodeList dtlNode = parser.ExtractAllNodesThatMatch(new AndFilter(new TagNameFilter("table"), new HasAttributeFilter("width", "960")));
