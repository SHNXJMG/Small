...
{
    public class InviteGanSuZfcg:WebSiteCrawller
    {
        public InviteGanSuZfcg()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "甘肃省公共资源交易中心招标信息(政府采购)";
            this.Description = "自动抓取甘肃省公共资源交易中心招标信息(政府采购)";
            this.PlanTime = "09:05,09:50,10:50,11:30,14:25,15:25,16:50";
            this.MaxCount = 200;
            this.SiteUrl = "http://www.gsggzyjy.cn/InfoPage/AnnoGoodsList.aspx?SiteItem=86&InfoType=3";
        }
