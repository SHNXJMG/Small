...
{
    public class InviteGuangXiGgzyJtgc : WebSiteCrawller
    {
        public InviteGuangXiGgzyJtgc()
            : base()
        {
            this.Group = "招标信息";
            ...
            this.MaxCount = 300;
            this.SiteUrl = "http://www.gxzbtb.cn/gxzbw/showinfo/jyxx.aspx?QuYu=450001&categoryNum=001012001";
        }
        ...
        protected Dictionary<string, string> GetCitys()
        {
            ...
            if (listNode != null && listNode.Count > 0)
            {
                for (int i = 0; i < listNode.Count; i++)
                {
                    ...
                    string url = string.Format("http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu={0}&categoryNum=001012001", id);
                    dic.Add(city, url);
                }
            }
            return dic;
