...
namespace Crawler.Instance
{
    ...
    /// 广东省惠州市惠阳区
    /// </summary>
    public class InviteHuiZhouHYQ : WebSiteCrawller
    {
        public InviteHuiZhouHYQ()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广东省惠州市惠阳区";
            this.Description = "自动抓取广东省惠州市惠阳区招标信息";
            ...
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000002/000000000383";
        }
