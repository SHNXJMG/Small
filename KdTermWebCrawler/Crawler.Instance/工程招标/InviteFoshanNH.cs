...
{
    public class InviteFoshanNH : WebSiteCrawller
    {
        public InviteFoshanNH()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广东省佛山市南海区";
            this.Description = "自动抓取广东省佛山市南海区招标信息";
            this.PlanTime = "01:08,9:08,10:08,11:38,14:08,15:08,17:38";
            this.SiteUrl = "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbnh/";
        }
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                ...
                if (sNode != null && sNode.Count > 0)
                {
                    for (int t = 0; t < sNode.Count; t++)
                    {
                        ...
                        InfoUrl = "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbnh/" + aTag.Link.GetReplace("./");
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            msgType = "佛山市南海区建设工程交易中心";
                            specType = "建设工程";
                            inviteType = prjName.GetInviteBidType();
                            InviteInfo info = ToolDb.GenInviteInfo("广东省", "佛山市区", "南海区", string.Empty, code, prjName, prjAddress, buildUnit, beginDate, endDate, inviteCtx, remark, msgType, inviteType, specType, otherType, InfoUrl, HtmlTxt);
