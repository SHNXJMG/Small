...
{
    public class InviteBeiJingYl : WebSiteCrawller
    {
        public InviteBeiJingYl()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "北京市建设工程发包承包交易中心招标信息(园林)";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取北京市建设工程发包承包交易中心招标信息(园林)";
            this.SiteUrl = "http://www.bcactc.com/home/gcxx/now_ylzbgg.aspx";
            this.MaxCount = 400;
        }
