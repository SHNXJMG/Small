...
{
    public class InviteGuangXiGgzy : WebSiteCrawller
    {
        public InviteGuangXiGgzy()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广西省公共资源交易中心招标信息(工程建设)";
            this.Description = "自动抓取广西省公共资源交易中心招标信息(工程建设)";
            this.PlanTime = "9:30,11:30,14:30,16:30,18:30";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.SiteUrl = "http://www.gxzbtb.cn/gxzbw/showinfo/jyxx.aspx?QuYu=450001&categoryNum=001001001";
        }
        ...
        protected Dictionary<string, string> GetCitys()
        {
            ...
            if (listNode != null && listNode.Count > 0)
            {
                for (int i = 0; i < listNode.Count; i++)
                {
                    ...
                    string url = string.Format("http://www.gxzbtb.cn/gxzbw/showinfo/MoreInfo.aspx?QuYu={0}&categoryNum=001001001", id);
                    dic.Add(city, url);
                }
            }
            return dic;
