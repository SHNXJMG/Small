...
namespace Crawler.Instance
{
    ...
    /// 广东省惠州市惠东县
    /// </summary>
    public class InviteHuiZhouHDX : WebSiteCrawller
    {
        public InviteHuiZhouHDX()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广东省惠州市惠东县";
            this.Description = "自动抓取广东省惠州市惠东县招标信息";
            ...
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000002/000000000429";
        }
