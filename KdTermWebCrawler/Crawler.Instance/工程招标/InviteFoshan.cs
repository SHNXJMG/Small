...
{
    public class InviteFoshan : WebSiteCrawller
    {
        public InviteFoshan()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广东省佛山市";
            this.Description = "自动抓取广东省佛山市区招标信息";
        ...
        protected Dictionary<string, string> DicSiteUrl
        {
            get
            {
                if (_dicSiteUrl == null)
                {
                    ...
                    _dicSiteUrl.Add("市直", "http://www.fsggzy.cn/gcjy/gc_zbxx/gc_zbsz/");
                    _dicSiteUrl.Add("禅城", "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbcc/");
                    _dicSiteUrl.Add("南海", "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbnh/");
                    _dicSiteUrl.Add("三水", "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbss/");
                    _dicSiteUrl.Add("高明", "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbgm/");
                    _dicSiteUrl.Add("顺德", "http://www.fsggzy.cn/gcjy/gc_zbxx/jygg_gq/gc_zbsd/");
                }
                return _dicSiteUrl;
            }
        }
