...
{
    public class InviteYunNanZtbZfcg : WebSiteCrawller
    {
        public InviteYunNanZtbZfcg()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "云南省公共资源政府采购招标信息";
            this.Description = "自动抓取云南省公共资源政府采购招标信息";
            this.PlanTime = "8:52,9:42,10:32,11:32,13:42,15:02,16:32";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.ynggzy.net/bulletininfo.do?method=bulletinMore&hySort=1&bulletinclass=01";
            this.MaxCount = 400;
        }
