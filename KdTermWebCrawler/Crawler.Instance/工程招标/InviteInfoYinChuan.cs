...
{
    public class InviteInfoYinChuan : WebSiteCrawller
    {
        public InviteInfoYinChuan()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "银川市公共资源交易中心招标信息";
            this.Description = "自动抓取银川市公共资源交易中心招标信息";
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.ycsggzy.cn/morelink.aspx?type=12&index=1&isbg=0";
            this.MaxCount = 500;
        }
