...
namespace Crawler.Instance
{
    ...
    /// 广东省惠州市惠州市直
    /// </summary>
    public class InviteHuiZhouHZSZ : WebSiteCrawller
    {
        public InviteHuiZhouHZSZ()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广东省惠州市惠州市直";
            this.Description = "自动抓取广东省惠州市惠州市直招标信息";
            ...
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000002/000000000201";
        } 
        ...
        public void DealHtml(IList list, string html, bool crawlAll)
        {
            ...
            if (aNodes != null && aNodes.Count > 0)
            {
                ...
                for (int t = 1; t < table.RowCount - 1; t++)
                {
                    ...
                    endDate = table.Rows[t].Columns[3].ToPlainTextString().Replace("\r\n", "").Replace("\t", "").Replace("&nbsp;", " ").Trim();
                    ...
                    InviteInfo info = ToolDb.GenInviteInfo("广东省", "惠州市区", "惠州市直", string.Empty, code, prjName, prjAddress, buildUnit, beginDate, endDate, ctx, remark, "惠州市建设工程交易中心", inviteType, "建设工程", string.Empty, InfoUrl, HtmlTxt);
                            list.Add(info);
