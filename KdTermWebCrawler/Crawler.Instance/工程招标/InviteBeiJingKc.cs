...
{
    public class InviteBeiJingKc : WebSiteCrawller
    {
        public InviteBeiJingKc()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "北京市建设工程发包承包交易中心招标信息(勘察设计)";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取北京市建设工程发包承包交易中心招标信息(勘察设计)";
            this.SiteUrl = "http://www.bcactc.com/home/gcxx/now_kcsjzbgg.aspx";
            this.MaxCount = 400;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 0; j < table.RowCount; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            beginDate = inviteCtx.GetRegex("登记日期,登记时间").GetDateRegex();
