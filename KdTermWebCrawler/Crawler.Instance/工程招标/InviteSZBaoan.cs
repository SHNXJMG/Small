...
{
    public class InviteSZBaoan : WebSiteCrawller
    {
        public InviteSZBaoan()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "广东省深圳市宝安区";
            this.Description = "自动抓取广东省深圳市宝安区招标信息";
            this.SiteUrl = "https://www.szjsjy.com.cn:8001/jyw-ba/jyxx/queryGongGaoList.do?page=1&rows=";
            this.MaxCount = 200;
