...
{
    public class InviteHbDaZhi : WebSiteCrawller
    {
        public InviteHbDaZhi()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "大冶市公共资源交易中心信息招标公告";
            this.Description = "自动抓取大冶市公共资源交易中心信息招标公告";
            this.PlanTime = "9:18";
            this.SiteUrl = "http://www.dyggzyjyzx.com/dyweb/jyxx/002001/002001001/MoreInfo.aspx?CategoryNum=002001001";
            this.MaxCount = 120;
        }
