...
{
    public class InviteJiangXiSlgc:WebSiteCrawller
    {
        public InviteJiangXiSlgc()
            : base()
        {
            this.Group = "招标信息";
            this.Title = "江西省公共资源交易中心招标信息(水利工程)";
            this.Description = "自动抓取江西省公共资源交易中心招标信息(水利工程)";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.SiteUrl = "http://www.jxsggzy.cn/web/jyxx/002003/002003001/jyxx.html";
        }
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
        {
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                    ...
                    SiteUrl = "http://www.jxsggzy.cn/web/jyxx/002003/002003001/" + i + ".html";
                    try
                    {
