...
{
    public class ItemPlanLghz:WebSiteCrawller
    {
        public ItemPlanLghz()
            : base()
        {
            this.Group = "项目立项";
            this.Title = "深圳市龙岗政府在线项目核准信息";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取深圳市龙岗政府在线项目核准信息";
            this.SiteUrl = "http://www.lg.gov.cn/col/col6802/index.html";
            this.MaxCount = 800;
        }
