...
{
    public class ItemPlanHeBeiTzxm : WebSiteCrawller
    {
        public ItemPlanHeBeiTzxm() :
            base()
        {
            this.Group = "项目立项";
            this.Title = "河北省投资项目管理系统项目立项（项目审批）";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取河北省投资项目管理系统项目立项（项目审批）";
            this.SiteUrl = "http://hebpi.net/portal/ShowMoreProjectAction.do?method=YsProListPage&page=1&rp=20";
            this.MaxCount = 500;
        }
