...
namespace Crawler.Instance.项目立项
{
    public class ItemPlanFuJianCzys:WebSiteCrawller
    {
        public ItemPlanFuJianCzys()
            : base()
        {
            this.Group = "项目立项";
            this.Title = "福建省发展和改革委员会项目立项财政预算";
            this.Description = "自动抓取福建省发展和改革委员会项目立项财政预算";
            this.PlanTime = "09:05,09:50,10:50,11:30,14:25,15:25,16:50";
            this.MaxCount = 400;
            this.SiteUrl = "http://www.fjdpc.gov.cn/xxgklist.aspx?ctlgid=456465";
        }
