...
{
    public class ItemPlanSzbahz : WebSiteCrawller
    {
        public ItemPlanSzbahz() :
            base()
        {
            this.Group = "项目立项";
            this.Title = "深圳市宝安区工程领域项目核准信息";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取深圳市宝安区工程领域项目核准信息";
            this.SiteUrl = "http://www.baoan.gov.cn/ztlm/gcjszt/gcjs/xmsp/xmhz/";
            this.MaxCount = 800;
        }
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
         {
            ...
            NodeList pageNode = parser.ExtractAllNodesThatMatch(new AndFilter(new TagNameFilter("div"), new HasAttributeFilter("class", "fenye")));
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 1; j < table.RowCount; j++)
                    {
                        ...
                        InfoUrl = this.SiteUrl + tr.Columns[1].GetATagHref().Replace("../", "").Replace("./", "");
