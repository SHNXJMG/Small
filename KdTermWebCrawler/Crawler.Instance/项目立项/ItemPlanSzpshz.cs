...
{
    public class ItemPlanSzpshz : WebSiteCrawller
    {
        public ItemPlanSzpshz()
            : base()
        {
            this.Group = "项目立项";
            this.Title = "深圳市坪山区工程领域项目核准信息";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取深圳市坪山区工程领域项目核准信息";
            this.SiteUrl = "http://other.sznews.com/pinshanproject/ProjectList.aspx?nodeid=2";
            this.MaxCount = 1200;
