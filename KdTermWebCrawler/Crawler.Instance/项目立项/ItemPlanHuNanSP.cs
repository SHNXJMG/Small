...
{
    public class ItemPlanHuNanSP : WebSiteCrawller
    {
        public ItemPlanHuNanSP()
            : base()
        {
            this.Group = "项目立项";
            this.Title = "湖南省发展和改革委员会项目立项审批信息";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取湖南省发展和改革委员会项目立项审批信息";
            this.SiteUrl = "http://www.hnfgw.gov.cn/xxgk/spgbsp/Index.html";
            this.MaxCount = 1200;
        }
