...
{
    public class ItemPlanSz : WebSiteCrawller
    {
        public ItemPlanSz() :
            base()
        {
            this.Group = "项目立项";
            this.Title = "深圳市发展和改革委员会项目审批";
            this.PlanTime = "9:04,11:04,13:04,15:04,17:04";
            this.Description = "自动抓取深圳市发展和改革委员会项目审批";
            this.SiteUrl = "http://www.szpb.gov.cn/fgzl/gcjslyxm/xmsp/xmsp/";
            this.MaxCount = 500;
        }
