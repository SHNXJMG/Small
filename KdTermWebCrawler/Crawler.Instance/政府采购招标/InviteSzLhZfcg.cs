...
{
    public class InviteSzLhZfcg : WebSiteCrawller
    {
        public InviteSzLhZfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "深圳市龙华新区政府采购公共资源交易中心招标信息（货物）";
            this.Description = "自动抓取深圳市龙华新区政府采购公共资源交易中心招标信息（货物）";
            this.PlanTime = "9:22,13:53";
            this.SiteUrl = "http://lhxq.szzfcg.cn/portal/topicView.do?method=view1&id=500100201&siteId=11&tstmp=15%3A25%3A51%20GMT%2B0800&page=1";
        }
