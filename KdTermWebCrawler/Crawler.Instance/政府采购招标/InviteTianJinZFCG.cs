...
{
    public class InviteTianJinZFCG : WebSiteCrawller
    {
        public InviteTianJinZFCG()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "天津市政府采购网(市级采购信息)";
            this.Description = "自动抓取天津市政府采购网(市级采购信息)";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 1000;
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.SiteUrl = "http://www.tjgp.gov.cn/portal/topicView.do?method=view&view=Infor&id=1665&ver=2&st=1";
        }
