...
{
    public class InviteSzPsXxgcZfcg : WebSiteCrawller
    {
        public InviteSzPsXxgcZfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "深圳市坪山新区公共资源交易中心小型工程招标信息（施工）";
            this.Description = "自动抓取深圳市坪山新区公共资源交易中心小型工程招标信息（施工）";
            this.PlanTime = "9:22,13:53";
            this.SiteUrl = "http://ps.szzfcg.cn/portal/topicView.do?method=view1&id=2887102&siteId=9&underwayFlag=undefined&tstmp=16%3A56%3A56%20GMT%2B0800&page=1";
        }
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
        {
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                if (i > 1)
                {
                    try
                    {
                        html = this.ToolWebSite.GetHtmlByUrl("http://ps.szzfcg.cn/portal/topicView.do?method=view1&id=2887102&siteId=9&underwayFlag=undefined&tstmp=16%3A56%3A56%20GMT%2B0800&page=" + i, Encoding.UTF8);
                    }
                    catch { continue; }
                }
