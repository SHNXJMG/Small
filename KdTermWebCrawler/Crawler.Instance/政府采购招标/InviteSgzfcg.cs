...
{
    public class InviteSgzfcg : WebSiteCrawller
    {
        public InviteSgzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "韶关市政府采购招标信息";
            this.PlanTime = "9:25,11:25,13:25,15:25,17:25";
            this.Description = "自动抓取韶关市政府采购招标信息";
            this.SiteUrl = "http://shaoguan.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    for (int j = 0; j < listNode.Count; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            msgType = "韶关市政府采购";
                            specType = "政府采购";
                            InviteInfo info = ToolDb.GenInviteInfo("广东省", "韶关市区", "", string.Empty, code, prjName, prjAddress, buildUnit, beginDate, endDate, inviteCtx, remark, msgType, inviteType, specType, otherType, InfoUrl, HtmlTxt);
