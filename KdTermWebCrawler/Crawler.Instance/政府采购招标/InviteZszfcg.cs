...
{
    public class InviteZszfcg : WebSiteCrawller
    {
        public InviteZszfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "中山市政府采购招标信息";
            this.PlanTime = "9:19,11:19,13:49,15:49,17:49";
            this.Description = "自动抓取中山市政府采购招标信息";
            this.SiteUrl = "http://zhongshan.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
                                ...
                                for (int k = 0; k < fileNode.Count; k++)
                                {
                                    ...
                                    if (fileAtag.IsAtagAttach())
                                    {
                                        ...
                                        if (!fileLink.ToLower().Contains("http"))
                                            fileLink = "http://zhongshan.gdgpo.gov.cn" + fileAtag.Link;
