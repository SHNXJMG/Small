...
{
    public class InviteMmzfcg : WebSiteCrawller
    {
        public InviteMmzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "茂名市政府采购招标信息";
            this.PlanTime = "9:08,11:08,13:08,15:08,17:08";
            this.Description = "自动抓取茂名市政府采购招标信息";
            this.SiteUrl = "http://maoming.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
