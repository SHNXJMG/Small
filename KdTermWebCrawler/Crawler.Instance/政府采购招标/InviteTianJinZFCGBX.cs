...
{
    public class InviteTianJinZFCGBX : WebSiteCrawller
    {
        public InviteTianJinZFCGBX()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "天津市政府采购网(其他标讯)";
            this.Description = "自动抓取天津市政府采购网(其他标讯)";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 1000;
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.SiteUrl = "http://www.tjgp.gov.cn/index!indexList?newsType=15";
        }
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
        {
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                ...
                CreateTime = string.Empty, msgType = string.Empty, otherType = string.Empty, HtmlTxt = string.Empty;
                        ...
                        prjName = System.Web.HttpUtility.HtmlDecode(prjName);
                        if (string.IsNullOrEmpty(prjName))
                            return list;
                        // prjName = server.HtmlDecode(prjName);//System.Web.HttpContext.Current.Server.HtmlDecode(prjName);
