...
{
    public class InviteGuiZhouFW:WebSiteCrawller 
    {
        public InviteGuiZhouFW()
            : base(true)
        {
            this.Group = "政府采购招标信息";
            this.Title = "贵州省发展和改革委员会服务招标";
            this.Description = "自动抓取贵州省发展和改革委员会服务招标";
            this.PlanTime = "9:30,11:30,14:30,16:30,18:30";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 500;
            this.SiteUrl = "http://www.gzzbw.cn/plus/list.php?tid=32";
        }
