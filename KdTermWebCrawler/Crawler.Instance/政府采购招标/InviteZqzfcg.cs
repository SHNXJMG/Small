...
{
    public class InviteZqzfcg : WebSiteCrawller
    {
        public InviteZqzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "肇庆市政府采购招标信息";
            this.PlanTime = "9:21,11:21,13:21,15:21,17:21";
            this.Description = "自动抓取肇庆市政府采购招标信息";
            this.SiteUrl = "http://zhaoqing.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
