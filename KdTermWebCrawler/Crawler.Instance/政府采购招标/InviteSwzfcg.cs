...
{
    public class InviteSwzfcg : WebSiteCrawller
    {
        public InviteSwzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "汕尾市政府采购招标信息";
            this.PlanTime = "9:13,11:13,13:13,15:13,17:13";
            this.Description = "自动抓取汕尾市政府采购招标信息";
            this.SiteUrl = "http://shanwei.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    for (int j = 0; j < listNode.Count; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            msgType = "汕尾市政府采购";
                            specType = "政府采购";
                            InviteInfo info = ToolDb.GenInviteInfo("广东省", "汕尾市区", "", string.Empty, code, prjName, prjAddress, buildUnit, beginDate, endDate, inviteCtx, remark, msgType, inviteType, specType, otherType, InfoUrl, HtmlTxt);
