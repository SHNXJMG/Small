...
{
    public class InviteStzfcg : WebSiteCrawller
    {
        public InviteStzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "汕头市政府采购招标信息";
            this.PlanTime = "9:23,11:23,13:23,15:23,17:23";
            this.Description = "自动抓取汕头市政府采购招标信息";
            this.SiteUrl = "http://shantou.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
                                ...
                                for (int k = 0; k < fileNode.Count; k++)
                                {
                                    ...
                                    if (fileAtag.IsAtagAttach())
                                    {
                                        ...
                                        if (!fileLink.ToLower().Contains("http"))
                                            fileLink = "http://shantou.gdgpo.gov.cn" + fileAtag.Link;
