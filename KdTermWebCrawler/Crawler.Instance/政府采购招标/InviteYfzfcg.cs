...
{
    public class InviteYfzfcg : WebSiteCrawller
    {
        public InviteYfzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "云浮市政府采购招标信息";
            this.PlanTime = "9:00,10:00,13:00,15:00,17:00";
            this.Description = "自动抓取云浮市政府采购招标信息";
            this.SiteUrl = "http://yunfu.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    for (int j = 0; j < listNode.Count; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            msgType = "云浮市政府采购";
                            specType = "政府采购";
                            InviteInfo info = ToolDb.GenInviteInfo("广东省", "云浮市区", "", string.Empty, code, prjName, prjAddress, buildUnit, beginDate, endDate, inviteCtx, remark, msgType, inviteType, specType, otherType, InfoUrl, HtmlTxt);
