...
{
    public class InviteSzPsXxgcFwZfcg : WebSiteCrawller
    {
        public InviteSzPsXxgcFwZfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "深圳市坪山新区公共资源交易中心小型工程招标信息（服务）";
            this.Description = "自动抓取深圳市坪山新区公共资源交易中心小型工程招标信息（服务）";
            this.PlanTime = "9:22,13:53";
            this.SiteUrl = "http://ps.szzfcg.cn/portal/topicView.do?method=view1&id=2887106&siteId=9&underwayFlag=undefined&tstmp=17%3A40%3A43%20GMT%2B0800&page=1";
        }
