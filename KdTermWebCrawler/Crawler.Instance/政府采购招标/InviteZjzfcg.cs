...
{
    public class InviteZjzfcg : WebSiteCrawller
    {
        public InviteZjzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "湛江市政府采购招标信息";
            this.PlanTime = "9:08,11:08,13:08,15:08,17:08";
            this.Description = "自动抓取湛江市政府采购招标信息";
            this.SiteUrl = "http://zhanjiang.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
        ...
        protected override IList ExecuteCrawl(bool crawlAll)
        {
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                if (i > 1)
                {
                    ...
                    try
                    {
                        html = this.ToolWebSite.GetHtmlByUrl("http://zhanjiang.gdgpo.com/queryMoreInfoList.do", nvc, Encoding.UTF8);
                    }
                    catch
                    {
                        continue;
