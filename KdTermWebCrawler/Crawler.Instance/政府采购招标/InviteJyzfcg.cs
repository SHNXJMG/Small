...
{
    public class InviteJyzfcg : WebSiteCrawller
    {
        public InviteJyzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "揭阳市政府采购招标信息";
            this.PlanTime = "9:02,10:02,13:02,15:02,17:02";
            this.Description = "自动抓取揭阳市政府采购招标信息";
            this.SiteUrl = "http://jieyang.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
