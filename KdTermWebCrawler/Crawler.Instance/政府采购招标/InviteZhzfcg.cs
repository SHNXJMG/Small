...
{
    public class InviteZhzfcg : WebSiteCrawller
    {
        public InviteZhzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "珠海市政府采购招标信息";
            this.PlanTime = "9:17,11:17,13:47,15:47,17:47";
            this.Description = "自动抓取珠海市政府采购招标信息";
            this.SiteUrl = "http://zhuhai.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
