...
{
    public class InviteHzzfcg : WebSiteCrawller
    {
        public InviteHzzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "惠州市政府采购招标信息";
            this.PlanTime = "9:35,11:35,13:35,15:35,17:35";
            this.Description = "自动抓取惠州市政府采购招标信息";
            this.SiteUrl = "http://huizhou.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
