...
{
    public class InviteHyzfcg : WebSiteCrawller
    {
        public InviteHyzfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "河源市政府采购招标信息";
            this.PlanTime = "9:29,11:29,13:29,15:29,17:29";
            this.Description = "自动抓取河源市政府采购招标信息";
            this.SiteUrl = "http://heyuan.gdgpo.com/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
