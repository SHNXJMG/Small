...
{
    public class InviteFszfcg : WebSiteCrawller
    {
        public InviteFszfcg()
            : base()
        {
            this.Group = "政府采购招标信息";
            this.Title = "佛山市政府采购招标信息";
            this.PlanTime = "9:15,11:15,13:45,15:45,17:45";
            this.Description = "自动抓取佛山市政府采购招标信息";
            this.SiteUrl = "http://foshan.gdgpo.gov.cn/queryMoreInfoList/channelCode/0005.html";
            this.MaxCount = 50;
        }
