...
{
    public class NoticeGuangXiJsgc : WebSiteCrawller
    {
        public NoticeGuangXiJsgc()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广西省公共资源交易中心通知公示(工程建设)";
            this.Description = "自动抓取广西省公共资源交易中心招标信息(工程建设)";
            this.PlanTime = "9:05,11:15,14:15,16:15,18:15";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.SiteUrl = "http://www.gxzbtb.cn/gxzbw/jyxx/001001/001001002/";
        }
