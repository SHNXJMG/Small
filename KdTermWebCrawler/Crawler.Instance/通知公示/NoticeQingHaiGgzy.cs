...
{
    public class NoticeQingHaiGgzy : WebSiteCrawller
    {
        public NoticeQingHaiGgzy()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "青海省公共资源交易平台通知公示";
            this.Description = "自动抓取青海省公共资源交易平台通知公示";
            this.PlanTime = "09:05,09:50,10:50,11:30,14:25,15:25,16:50";
            this.MaxCount = 400;
            this.SiteUrl = "http://qhzbtb.qhwszwdt.gov.cn/qhweb/jyxx/005001/005001003/MoreInfo.aspx?CategoryNum=005001003";
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 0; j < table.RowCount; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            NoticeInfo info = ToolDb.GenNoticeInfo("青海省", "青海省及地市", "", string.Empty, InfoTitle, InfoType, InfoCtx, PublistTime, string.Empty, "青海省公共资源交易监督管理局", InfoUrl, prjCode, buildUnit, string.Empty, string.Empty, "政府采购", string.Empty, htmlTxt);
                            list.Add(info);
                                ...
                                for (int k = 0; k < aNode.Count; k++)
                                {
                                    ...
                                    if (a.IsAtagAttach())
                                    {
                                        ...
                                        if (a.Link.ToLower().Contains("http"))
                                            ...
                                            link = "http://qhzbtb.qhwszwdt.gov.cn/" + a.Link;
