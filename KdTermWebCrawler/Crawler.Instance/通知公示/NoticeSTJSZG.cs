...
{
    public class NoticeSTJSZG : WebSiteCrawller
    {
        public NoticeSTJSZG()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广东省汕头建设网资格预审";
            this.PlanTime = "9:15,11:15,14:15,17:15";
            this.Description = "自动抓取广东省汕头建设网资格预审";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.stjs.gov.cn/zbtb/zhaobiao_zhige.asp";
            this.MaxCount = 600;
        }
