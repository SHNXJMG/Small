...
{
    public class NoticeHZJSLM : WebSiteCrawller
    {
        public NoticeHZJSLM()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广东省惠州市建设工程交易中心（龙门县）资格预审";
            this.PlanTime = "9:16,11:16,14:16,17:16";
            this.Description = "自动抓取广东省惠州市建设工程交易中心（龙门县）资格预审";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000003/000000000421";
            this.MaxCount = 500;
        }
