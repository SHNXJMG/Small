...
{
    public class NoticeGuangXiSlgc : WebSiteCrawller
    {
        public NoticeGuangXiSlgc()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广西省公共资源交易中心通知公示(水利工程)";
            this.Description = "自动抓取广西省公共资源交易中心招标信息(水利工程)";
            this.PlanTime = "9:05,11:15,14:15,16:15,18:15";
            this.ExistCompareFields = "InfoUrl";
            this.MaxCount = 300;
            this.SiteUrl = "http://www.gxzbtb.cn/gxzbw/jyxx/001011/001011003/";
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 0; j < table.RowCount - 1; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            NoticeInfo info = ToolDb.GenNoticeInfo("广西壮族自治区", "广西壮族自治区及地市", area, string.Empty, InfoTitle, InfoType, InfoCtx, PublistTime, string.Empty, "广西壮族自治区公共资源交易中心", InfoUrl, prjCode, buildUnit, string.Empty, string.Empty, "水利工程", string.Empty, htmlTxt);
