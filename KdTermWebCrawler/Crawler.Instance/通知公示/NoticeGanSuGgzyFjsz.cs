...
{
    public class NoticeGanSuGgzyFjsz : WebSiteCrawller
    {
        public NoticeGanSuGgzyFjsz()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "甘肃省公共资源交易中心通知公示(房建市政工程)";
            this.Description = "自动抓取甘肃省公共资源交易中心通知公示(房建市政工程)";
            this.PlanTime = "09:05,09:50,10:50,11:30,14:25,15:25,16:50";
            this.MaxCount = 200;
            this.SiteUrl = "http://www.gsggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=126&InfoType=7";
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    for (int j = 0; j < listNode.Count; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            NoticeInfo info = ToolDb.GenNoticeInfo("甘肃省", "甘肃省及地市", area, string.Empty, InfoTitle, InfoType, InfoCtx, PublistTime, string.Empty, "甘肃省公共资源交易中心", InfoUrl, prjCode, buildUnit, string.Empty, string.Empty, "房建市政工程", string.Empty, htmlTxt);
