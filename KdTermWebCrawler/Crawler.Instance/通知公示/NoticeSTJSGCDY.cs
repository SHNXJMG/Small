...
{
    public class NoticeSTJSGCDY : WebSiteCrawller
    {
        public NoticeSTJSGCDY()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广东省汕头建设网网上答疑";
            this.PlanTime = "9:14,11:14,14:14,17:14";
            this.Description = "自动抓取广东省汕头建设网网上答疑";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.stjs.gov.cn/zbtb/zhaobiao_wsdy.asp";
            this.MaxCount = 600;
        }
