...
{
    public class NoticeSTJSCQ : WebSiteCrawller
    {
        public NoticeSTJSCQ()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广东省汕头建设网抽签情况";
            this.PlanTime = "9:17,11:17,14:17,17:17";
            this.Description = "自动抓取广东省汕头建设网抽签情况";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.stjs.gov.cn/zbtb/zhaobiao_cqqiankuan.asp";
            this.MaxCount = 600;
        }
