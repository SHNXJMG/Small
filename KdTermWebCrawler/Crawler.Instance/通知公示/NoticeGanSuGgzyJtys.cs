...
{
    public class NoticeGanSuGgzyJtys:WebSiteCrawller
    {
        public NoticeGanSuGgzyJtys()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "甘肃省公共资源交易中心通知公示(交通运输工程)";
            this.Description = "自动抓取甘肃省公共资源交易中心通知公示(交通运输工程)";
            this.PlanTime = "09:05,09:50,10:50,11:30,14:25,15:25,16:50";
            this.MaxCount = 200;
            this.SiteUrl = "http://www.gsggzyjy.cn/InfoPage/InfoList.aspx?SiteItem=134&InfoType=7";
        }
