...
{
    public class NoticeHuBeiGgzyFjsz : WebSiteCrawller
    {
        public NoticeHuBeiGgzyFjsz()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "湖北省公共资源交易中心澄清修改通知(房建市政工程)";
            this.Description = "自动抓取湖北省公共资源交易中心澄清修改通知(房建市政工程)";
            this.PlanTime = "09:05,09:50,10:50,11:30,14:25,15:25,16:50";
            this.MaxCount = 400;
            this.SiteUrl = "http://www.hbggzy.cn/hubeizxwz/jyxx/004001/004001005/004001005001/MoreInfo.aspx?CategoryNum=004001005001";
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 0; j < table.RowCount; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            NoticeInfo info = ToolDb.GenNoticeInfo("湖北省", "湖北省及地市", "", string.Empty, InfoTitle, InfoType, InfoCtx, PublistTime, string.Empty, "湖北省公共资源交易中心", InfoUrl, prjCode, buildUnit, string.Empty, string.Empty, "房建市政工程", string.Empty, htmlTxt);
                            list.Add(info);
