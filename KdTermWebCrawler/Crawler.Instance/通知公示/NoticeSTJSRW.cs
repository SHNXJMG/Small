...
{
    public class NoticeSTJSRW : WebSiteCrawller
    {
        public NoticeSTJSRW()
            : base()
        {
            this.Group = "通知公示";
            this.Title = "广东省汕头建设网入围公告";
            this.PlanTime = "9:16,11:16,14:16,17:16";
            this.Description = "自动抓取广东省汕头建设网入围公告";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.stjs.gov.cn/zbtb/zhaobiao_ruwei.asp";
            this.MaxCount = 600;
        }
