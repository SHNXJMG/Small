...
{
    public class InviteHzHuangBu : WebSiteCrawller
    {
        public InviteHzHuangBu()
            : base()
        {
            this.Group = "街道办招标信息";
            this.Title = "广东省惠州市惠城区黄埠镇人民政府招标、中标公告";
            this.Description = "自动抓取广东省惠州市惠城区黄埠镇人民政府招标、中标公告";
            this.PlanTime = "9:18";
            this.SiteUrl = "http://huangbu.huidong.gov.cn/bigClassdeta.asp?typeid=66&BigClassid=230&BigClassName=";
            this.MaxCount = 120;
        }
