...
{
    public class InviteHzRuHu : WebSiteCrawller
    {
        public InviteHzRuHu()
            : base()
        {
            this.Group = "街道办招标信息";
            this.Title = "广东省惠州市惠城区汝湖镇人民政府招标、中标公告";
            this.Description = "自动抓取广东省惠州市惠城区汝湖镇人民政府招标、中标公告";
            this.PlanTime = "9:18";
            this.SiteUrl = "http://www.investruhu.com/digital.asp?genusid=1214";
            this.MaxCount = 120;
        }
                ...
                if (viewList != null && viewList.Count > 0)
                {
                    ...
                    for (int j = 1; j < table.RowCount; j++)
                    {
                        ...
                        if (prjName.Contains("中标") || prjName.Contains("成交") || prjName.Contains("结果"))
                        {
                            ...
                            InfoUrl = "http://www.investruhu.com/" + aTag.Link;
                            ...
                            if (dtl != null && dtl.Count > 0)
                            {
                                ...
                                string temp = bidCtx.GetRegex("工程名称,项目名称");
                                ...
                                if (prjName.Contains("…"))
                                {
                                    ...
                                    {
                                        prjName = nodeName[0].ToNodePlainString();
                                    }
                                }
                                    ...
                                    for (int k = 0; k < aNode.Count; k++)
                                    {
                                        ...
                                        if (a.IsAtagAttach())
                                        {
                                            ...
                                            if (a.Link.ToLower().Contains("http"))
                                                ...
                                                link = "http://www.investruhu.com/" + a.Link;
