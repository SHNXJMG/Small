...
{
    public class InviteHzBaoKou : WebSiteCrawller
    {
        public InviteHzBaoKou()
            : base()
        {
            this.Group = "街道办招标信息";
            this.Title = "广东省惠州市惠东县宝口镇人民政府招标、中标公告";
            this.Description = "自动抓取广东省惠州市惠东县宝口镇人民政府招标、中标公告";
            this.PlanTime = "9:18";
            this.SiteUrl = "http://baokou.huidong.gov.cn/bigClassdeta.asp?typeid=51&BigClassid=207";
            this.MaxCount = 120;
        }
