...
{
    public class InviteShiYan : WebSiteCrawller
    {
        public InviteShiYan()
            : base()
        {
            ...
            this.Description = "自动抓取广东省深圳市石岩街道办事处招标信息";
            this.PlanTime = "9:16,13:46";
            this.SiteUrl = "http://syjdb.baoan.gov.cn/xxgk_12101/ywxx/zbcg/zbxxgs/index.html";
        } 
