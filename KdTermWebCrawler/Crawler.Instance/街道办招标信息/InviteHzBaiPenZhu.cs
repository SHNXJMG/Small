...
{
    public class InviteHzBaiPenZhu : WebSiteCrawller
    {
        public InviteHzBaiPenZhu()
            : base()
        {
            this.Group = "街道办招标信息";
            this.Title = "广东省惠州市惠东县白盆珠镇人民政府招标、中标公告";
            this.Description = "自动抓取广东省惠州市惠东县白盆珠镇人民政府招标、中标公告";
            this.PlanTime = "9:18";
            this.SiteUrl = "http://baipenzhu.huidong.gov.cn/bigClassdeta.asp?typeid=53&BigClassid=227";
            this.MaxCount = 120;
        }
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                ...
                if (viewList != null && viewList.Count > 0)
                {
                    for (int j = 0; j < viewList.Count; j++)
                    {
                        ...
                        InfoUrl = "http://baipenzhu.huidong.gov.cn/" + aTag.Link;
                        ...
                        if (dtl != null && dtl.Count > 0)
                        {
                          ...
                          prjMgr = string.Empty, otherType = string.Empty;
                                ...
                                if (prjName.Contains("（"))
                                    prjName = prjName.GetRegexBegEnd("（", "）");
                                ...
                                if (imgNode != null && imgNode.Count > 0)
                                {
                                    ...
                                    src = "http://baipenzhu.huidong.gov.cn/" + imgUrl;
                                    ...
                                    for (int k = 0; k < aNode.Count; k++)
                                    {
                                        ...
                                        if (a.IsAtagAttach())
                                        {
                                            ...
                                            if (a.Link.ToLower().Contains("http"))
                                                ...
                                                link = "http://baipenzhu.huidong.gov.cn/" + a.Link;
