...
{
    public class InviteHzPingHai : WebSiteCrawller
    {
        public InviteHzPingHai()
            : base()
        {
            this.Group = "街道办招标信息";
            this.Title = "广东省惠州市惠东县平海镇人民政府招标、中标公告";
            this.Description = "自动抓取广东省惠州市惠东县平海镇人民政府招标、中标公告";
            this.PlanTime = "9:18";
            this.SiteUrl = "http://pinghai.huidong.gov.cn/bigClassdeta.asp?typeid=47&BigClassid=322";
            this.MaxCount = 120;
        }
            ...
            for (int i = 1; i <= pageInt; i++)
            {
                ...
                if (viewList != null && viewList.Count > 0)
                {
                    for (int j = 0; j < viewList.Count; j++)
                    {
                        ...
                        InfoUrl = "http://pinghai.huidong.gov.cn/" + aTag.Link;
                        ...
                        if (dtl != null && dtl.Count > 0)
                        {
                          ...
                          prjMgr = string.Empty, otherType = string.Empty;
                                ...
                                if (imgNode != null && imgNode.Count > 0)
                                {
                                    ...
                                    src = "http://pinghai.huidong.gov.cn/" + imgUrl;
                                    ...
                                    for (int k = 0; k < aNode.Count; k++)
                                    {
                                        ...
                                        if (a.IsAtagAttach())
                                        {
                                            ...
                                            if (a.Link.ToLower().Contains("http"))
                                                ...
                                                link = "http://pinghai.huidong.gov.cn/" + a.Link;
