...
{
    public class MeetInfoSzLh : WebSiteCrawller
    {
        public MeetInfoSzLh()
            : base()
        {
            this.Group = "会议信息";
            this.Title = "广东省深圳市政府采购罗湖分中心";
            this.Description = "自动抓取广东省深圳市政府采购罗湖分中心";
            ...
            this.SiteUrl = "http://lh.szzfcg.cn/";
        }
                ...
                for (int i = 0; i < table.RowCount; i++)
                {
                    ...
                    if (tr.GetAttribute("valign") == "top")
                    {
                        ...
                        MeetInfo info = ToolDb.GenMeetInfo("广东省", "深圳政府采购", string.Empty, string.Empty, prjName, place, meetName, meetTime,
                              string.Empty, "深圳市政府采购罗湖分中心", SiteUrl, code, builUnit, string.Empty, string.Empty);
                        list.Add(info);
                        ...
                        if (!crawlAll && list.Count >= this.MaxCount)
                        {
                            ...
                            string sqlwhere = " where City='深圳政府采购' and InfoSource='深圳市政府采购罗湖分中心' and BeginDate>='" + bDate + "' and BeginDate<='" + eDate + "'";
