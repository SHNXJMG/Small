...
{
    public class MeetInfoZhMr : WebSiteCrawller
    {
        public MeetInfoZhMr()
            : base()
        {
            this.Group = "会议信息";
            this.Title = "广东省珠海市公共资源交易中心今日议程(明日工作)";
            this.Description = "自动抓取广东省珠海市公共资源交易中心今日议程(明日工作)";
            ...
            this.SiteUrl = "http://www.cpinfo.com.cn/index/showList/000000000004/000000000393";
        }
