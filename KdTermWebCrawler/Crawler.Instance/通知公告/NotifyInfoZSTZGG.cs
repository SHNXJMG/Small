...
{
    public class NotifyInfoZSTZGG : WebSiteCrawller
    {
        public NotifyInfoZSTZGG()
            : base()
        {
            this.Group = "通知公告";
            this.Title = "广东省中山市建设工程交易信息网通知公告";
            this.Description = "自动抓取广东省中山市建设工程交易信息网通知公告";
            this.PlanTime = "21:55";
            this.SiteUrl = "http://www.zsjyzx.gov.cn/zsweb/index/showList/000000000010/000000000020";
            this.MaxCount = 500;
        }
