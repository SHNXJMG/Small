...
{
    public class NotifyInfoGzjgjg : WebSiteCrawller
    {
        public NotifyInfoGzjgjg()
            : base()
        {
            this.Group = "通知公告";
            this.Title = "广东省广州市监管机构公告";
            this.Description = "自动抓取广东省广州市监管机构公告";
            this.PlanTime = "21:55";
            this.SiteUrl = "http://www.gzggzy.cn/cms/wz/view/index/layout2/tzgglist.jsp?siteId=1&channelId=41";
            this.MaxCount = 500;
        }
