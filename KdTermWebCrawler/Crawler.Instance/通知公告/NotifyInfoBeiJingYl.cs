...
{
    public class NotifyInfoBeiJingYl : WebSiteCrawller
    {
        public NotifyInfoBeiJingYl()
            : base()
        {
            this.Group = "通知公告";
            this.Title = "北京工程建设交易信息网通知公告(园林)";
            this.Description = "自动抓取北京工程建设交易信息网通知公告(园林)";
            this.PlanTime = "8:54,9:44,10:34,11:34,13:44,15:04,16:34";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.bcactc.com/home/news/newslist.aspx?type=4";
            this.MaxCount = 200;
        }
