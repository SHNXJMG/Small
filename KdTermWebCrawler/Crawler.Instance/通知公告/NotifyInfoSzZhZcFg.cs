...
{
    public class NotifyInfoSzZhZcFg : WebSiteCrawller
    {
        public NotifyInfoSzZhZcFg()
            : base()
        {
            this.Group = "通知公告";
            this.Title = "广东省深圳市政府采购政策法规通知公告";
            this.Description = "自动抓取广东省深圳市政府采购政策法规通知公告";
            this.PlanTime = "21:00";
            this.SiteUrl = "http://www.szzfcg.cn/portal/topicView.do?method=view&id=1994";
        }
