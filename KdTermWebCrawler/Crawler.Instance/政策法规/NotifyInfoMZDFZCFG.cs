...
{
    public class NotifyInfoMZDFZCFG : WebSiteCrawller
    {
        public NotifyInfoMZDFZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省梅州市建设工程交易中心（梅州规章）政策法规";
            this.Description = "自动抓取广东省梅州市建设工程交易中心（梅州规章）政策法规";
            this.PlanTime = "1 22:28";
            this.SiteUrl = "http://market.meizhou.gov.cn/deptWebsiteAction.do?action=secondIndex&deptId=1925&issueTypeCode=009001005&issueTypeName=梅州规章政策&showSubNodeflag=1";
            this.MaxCount = 500;
