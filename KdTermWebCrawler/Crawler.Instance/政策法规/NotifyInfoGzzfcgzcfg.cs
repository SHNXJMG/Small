...
{
    public class NotifyInfoGzzfcgzcfg:WebSiteCrawller
    {
        public NotifyInfoGzzfcgzcfg()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省广州市政府采购政策法规";
            this.Description = "自动抓取广东省广州市政府采购政策法规";
            this.PlanTime = "1 22:24";
            this.SiteUrl = "http://www.gzggzy.cn/cms/wz/view/index/layout2/zcfglist.jsp?siteId=1&channelId=769";
            this.MaxCount = 500;
        }
                ...
                if (listNode != null && listNode.Count > 0)
                {
                    ...
                    for (int j = 1; j < table.RowCount; j++)
                    {
                        ...
                        if (dtlNode != null && dtlNode.Count > 0)
                        {
                            ...
                            msgType = "广州公共资源交易中心";
                            infoType = "政策法规";
                            NotifyInfo info = ToolDb.GenNotifyInfo(headName, releaseTime, infoScorce, msgType, infoUrl, ctxHtml, "广东省", "广州政府采购", string.Empty, infoCtx, infoType);
                            sqlCount++;
