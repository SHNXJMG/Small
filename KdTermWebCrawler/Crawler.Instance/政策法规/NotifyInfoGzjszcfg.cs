...
{
    public class NotifyInfoGzjszcfg : WebSiteCrawller
    {
        public NotifyInfoGzjszcfg()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省广州市建设工程政策法规";
            this.Description = "自动抓取广东省广州市建设工程政策法规";
            this.PlanTime = "1 22:24";
            this.SiteUrl = "http://www.gzggzy.cn/cms/wz/view/index/layout2/zcfglist.jsp?siteId=1&channelId=768";
            this.MaxCount = 500;
        }
