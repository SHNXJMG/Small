...
{
    public class NotifyInfoHZDFZCFG : WebSiteCrawller
    {
        public NotifyInfoHZDFZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省惠州市建设工程交易中心（地方法规）政策法规";
            this.PlanTime = "1 22:30";
            this.Description = "自动抓取广东省惠州市建设工程交易中心（地方法规）政策法规";
            this.ExistCompareFields = "InfoUrl";
            this.SiteUrl = "http://www.ebc.huizhou.gov.cn/index/showList/000000000007/000000000405";
            this.MaxCount = 500;
        }
