...
{
    public class NotityInfoDGGJZCFG : WebSiteCrawller
    {
        public NotityInfoDGGJZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省东莞市建设工程交易中心国家政策法规";
            this.Description = "自动抓取广东省东莞市建设工程交易中心国家政策法规";
            this.PlanTime = "1 22:24";
            this.SiteUrl = "http://www.dgzb.com.cn/DGJYWEB/SiteManage/Policy_List.aspx?ModeId=1";
            this.MaxCount = 500;
        }
