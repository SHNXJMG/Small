...
{
    public class NotifyInfoGZZCFG : WebSiteCrawller
    {
        public NotifyInfoGZZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省广州市建设工程交易中心政策法规";
            this.Description = "自动抓取广东省广州市建设工程交易中心政策法规";
            this.PlanTime = "1 22:16";
            this.SiteUrl = "http://www.gzzb.gd.cn/cms/wz/view/fwzn/zcfg.jsp?siteId=1&channelId=65";
            this.MaxCount = 500;
