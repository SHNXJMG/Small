...
{
    public class NotifyInfoSGZCFG : WebSiteCrawller
    {
        public NotifyInfoSGZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省韶关市建设与房地产信息网政策法规";
            this.Description = "自动抓取广东省韶关市建设与房地产信息网政策法规";
            this.PlanTime = "1 22:20";
            this.SiteUrl = "http://www.sgjsj.gov.cn/sgwebims/MessageSearchResult.aspx?ColumnID=251&KeyWord=";
            this.MaxCount = 500;
