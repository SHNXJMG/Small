...
{
    public class NotifyInfoSZGJZCFG : WebSiteCrawller
    {
        public NotifyInfoSZGJZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省深圳市建设工程交易中心国家政策法规";
            this.Description = "自动抓取广东省深圳市建设工程交易中心国家政策法规";
            this.PlanTime = "1 22:22";
            this.SiteUrl = "http://www.szjsjy.com.cn/ServiceGuide/PolicyRegulations.aspx?id=631";
            this.MaxCount = 500;
