...
{
    public class NotifyInfoZSGDZCFG : WebSiteCrawller
    {
        public NotifyInfoZSGDZCFG()
            : base()
        {
            this.Group = "政策法规";
            this.Title = "广东省中山市建设工程交易信息网省级政策法规";
            this.Description = "自动抓取广东省中山市建设工程交易信息网省级政策法规";
            this.PlanTime = "1 22:26";
            this.SiteUrl = "http://www.zsjyzx.gov.cn/zsweb/index/showList/000000000007/000000000406";
            this.MaxCount = 500;
        }
